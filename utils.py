...
def explanation_of_plots():
    ...
    st.subheader(":blue[_A brief note about the plots:_]")
...
def add_border():
    import streamlit as st
    return st.markdown("""<hr style="border: 3px solid #ff6961">""", unsafe_allow_html=True)

# #0892d0  #ff6961 #50c878 ##0892d0